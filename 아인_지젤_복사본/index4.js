...
(function () {
    ...
    var slide = {
        ...
        reset: {
            ...
            interval: function() {
                console.log(slide.elem.pauseBtn.classList)
                console.log(slide.elem.pauseBtn.classList.value)
                
                
                if (slide.elem.pauseBtn.classList[0] ===  "stop") {
                    console.log(111)
                    clearInterval(slide.autoPlays());
        ...
        autoPlays: function() {
            console.log(slide.event.next())
            setInterval(function(){slide.event.next()}, 3500);
        },
